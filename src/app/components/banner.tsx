      ...
      <section>
          ...
          <div className={vstack({gap: '4'})}>
            <div className={css({
              ...
              <h2 className={css({
                ...
                fontWeight: 'bold',
                color: 'gray.900'
              })}>Meeting scheduling <span
                className={css({color: 'orange.600'})}>made easy</span></h2>
            </div>
            <p className={css({
              maxWidth: '3xl',
              fontSize: "md",
              ...
              Read your smart “Daily Agenda” every morning.</p>
          </div>
        ...
        <div>
          <div className={css({mx: "auto"})}>
            <Image className={css({mx: "auto"})} src={Illustration}
                   alt="illustration picture image" height="600" width="600"/>
          </div>
        </div>
      </section>
    </Container>
